...
class CurlSoap
{
    ...
    public function send($urlservice, $namespace, $header, $body, $method)
    {
        ...
        if (empty($resposta)) {
            ...
            file_put_contents(PATH_ROOT."/log/err_curl_".date("YmdHis").".log", print_r($this, true));
    ...
    public function setPubKeyPath($pubKeyPath) {
        $this->pubKeyPath = $pubKeyPath;
    }

    public function setPriKeyPath($priKeyPath) {
        $this->priKeyPath = $priKeyPath;
    }
