...
class BaseTools
{
    ...
    public function __construct($configJson = '')
    {
        ...
        if (is_file($this->aConfig['pathCertsFiles'] . $this->aConfig['certPfxName'])){
            
            $content = file_get_contents($this->aConfig['pathCertsFiles'] . $this->aConfig['certPfxName']);

            $password = $this->aConfig['certPassword'];
           
            $this->oCertificate = Certificate::readPfx($content, $password);
        } else {
        ...
        $this->certExpireTimestamp = $this->oCertificate->publicKey->validTo;
